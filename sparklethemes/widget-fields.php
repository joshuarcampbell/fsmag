...
*/
require fsmag_file_directory('sparklethemes/widget/widget-large-with-grid.php');

require fsmag_file_directory('sparklethemes/widget/widget-large-with-small.php');

require fsmag_file_directory('sparklethemes/widget/widget-grid-posts.php');

require fsmag_file_directory('sparklethemes/widget/widget-large-single-with-small.php');

require fsmag_file_directory('sparklethemes/widget/widget-alternative-posts.php');

require fsmag_file_directory('sparklethemes/widget/widget-recent-random.php');

require fsmag_file_directory('sparklethemes/widget/widget-slider-posts.php');

require fsmag_file_directory('sparklethemes/widget/widget-timeline-posts.php');

require fsmag_file_directory('sparklethemes/widget/widget-tabbed.php');