<?php
/**
 * Adds fsmag_large_single_with_small_widget widget.
*/
add_action('widgets_init', 'fsmag_large_single_with_small_widget');

function fsmag_large_single_with_small_widget() {
    register_widget('fsmag_large_single_with_small_widget_area');
}

class fsmag_large_single_with_small_widget_area extends WP_Widget {
    ...
    */
    public function __construct() {
        parent::__construct(
            'emag_magazine_single_grid_posts', esc_html_x('EMag Large Single & Small Posts', 'widget name', 'fsmag'),
            array(
                'classname' => 'emag_magazine_single_grid_posts',
                'description' => esc_html__('Widget display 1 large single thumbinal image post with multiple small thumbinal posts', 'fsmag'),
