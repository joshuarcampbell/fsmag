...
*/
require fsmag_file_directory('foobar/widget/widget-large-with-grid.php');

require fsmag_file_directory('foobar/widget/widget-large-with-small.php');

require fsmag_file_directory('foobar/widget/widget-grid-posts.php');

require fsmag_file_directory('foobar/widget/widget-large-single-with-small.php');

require fsmag_file_directory('foobar/widget/widget-alternative-posts.php');

require fsmag_file_directory('foobar/widget/widget-recent-random.php');

require fsmag_file_directory('foobar/widget/widget-slider-posts.php');

require fsmag_file_directory('foobar/widget/widget-timeline-posts.php');

require fsmag_file_directory('foobar/widget/widget-tabbed.php');